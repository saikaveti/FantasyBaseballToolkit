...
class AdvancedPlayer:
    ...
    def __init__(self, first_name, last_name, team, Age, AB, H, DOUBLE, TRIPLE, HR, BB, HBP, BA, OBP, SLG, OPS, IBB, SB, CS, GIDP, SH, SF, R, RBI, SO):
    ...
    def print_player(self):
        print("First Name: {}, Last Name: {}, Team: {!s}, Age: {!s}, AB: {!s}, H: {!s}, 2B: {!s}, 3B: {!s}, HR: {!s}, BB: {!s}, HBP: {!s}, IBB: {!s}, SB: {!s}, CS: {!s}, GIDP: {!s}, SH: {!s}, SF: {!s}, BA: {!s}, OBP: {!s}, SLG: {!s}, OPS: {!s}, TB: {!s}, RC: {!s}, TA: {!s}, ISO: {!s}, SECA: {!s}, RC27: {!s}".format(self.first_name, self.last_name, self.team, self.AB, self.H, self.DOUBLE, self.TRIPLE, self.HR, self.BB, self.HBP, self.IBB, self.SB, self.CS, self.GIDP, self.SH, self.SF, self.BA, self.OBP, self.SLG, self.OPS, self.TB, self.RC, self.TA, self.ISO, self.SECA, self.RC27))
